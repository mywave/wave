...
!
! Revision 1.2  2004/02/18 16:34:15  frkochw
! Zusätzliche Items für automatische Richtungsfindung.
!
! Revision 1.1  2004/01/06 14:03:49  frkochw
! Übergang auf CVS
!
!
...
Keiner:			None
KeineRichtungen:	No directions found
Mischen:		Merge
Grau:			Gray
Spektrale:		Spectral directions
Scalloping:		Scalloping
Farbkodierung:		Colorcoding
LaengenBreiten:		Longitudes and latitudes
FFTRichtungen:		FFT directions
EindeutigeRichtungen:	Unique directions
Drucken:		Print
Analysenauswahl:	 Analysis menu
Clear:			Clear 
Modell:			Model
Heading:		Heading: 
ERSDaten:		/h/frkochw/ori/
OKohneLG:		OK without LG
BandBild:		 Tapenumber-imagenumber <ENTER> 
KeinStreifenName:	No name chosen for SAR strip
Ebene:			 Plane
Palette:		/h/frkochw/paletten/rainbow.hdf
noSUNraster:		This is not a SUN Rasterfile !
oirms:			/h/frkochw/02/vs/
Inhalt:			/h/frkochw/ERS/Band
Wind:			 histogram of wind
WindVerteilung:		Wind Speed Distribution over Sea
Gegenwind:		up-wind 
Querwind:		cross-wind 
...
Druckausrechnen:	Compute air pressure
Modellanzeigen:		Display model
Tabelleausgeben:	Output table
Datensichern:		Save data
