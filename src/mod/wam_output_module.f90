...
REAL, PARAMETER       :: ZMISS_ICE =  -9.    !! MISSING VALUE (ICE)
REAL, PARAMETER       :: ZMISS_DRY =  -8.    !! MISSING VALUE (DRY)
...
&                        AMOWEP, AMOSOP, AMOEAP, AMONOP, SCAL_P(IP))
      END IF
   END IF
