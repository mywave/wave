...
wam_interface_module.o wam_grid_module.o wam_model_module.o \
wam_boundary_module.o preproc_module.o wam_special_module.o \
...
preproc:
	mpif90 -ccl ifort $(OBJECTS) -o preproc -L/usr/lib64
